...
const UpdateClient = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const { error } = await supabase
      .from('clients')
      .update({ name, email, phone,address,taxId,gstNo,startdate,endDate,annualRevenue,acNo,acType,status,notes })
      .eq('id', id);
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center p-6">
      ...
      <Card className="w-full sm:w-96 p-8 shadow-lg rounded-lg bg-white dark:bg-gray-800">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Update Client Record</h2>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mt-6">
        <Button type="submit" className="w-full py-3 bg-blue-600 text-white rounded-md">Update Client</Button></div>
      </form>
